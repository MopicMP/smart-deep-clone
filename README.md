...
> Smart deep clone any python object (no pickle)

[![PyPI version](https://badge.fury.io/py/smart-deep-clone.svg)](https://pypi.org/project/smart-deep-clone/)
...
result = clone("Hello World")

# Example 2: Batch processing
from smart_deep_clone import batch
